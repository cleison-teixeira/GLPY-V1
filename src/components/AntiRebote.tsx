...
const PROTOCOL_POSTER = '/protocol-posters/anti-rebote.png';
...
export default function AntiRebote({ onNavigate }: { onNavigate: (screen: string) => void }) {
  ...
  useEffect(() => {
    // Se o usuário já concluiu um dia hoje e está apenas navegando entre dias,
    // não sobrescrever glpy_protocol_day_today com o próximo dia bloqueado.
                ...
                {!videoStarted && (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '16px',
                      background: `linear-gradient(rgba(10,22,40,0.60) 0%, rgba(10,22,40,0.72) 100%), url('${PROTOCOL_POSTER}')`,
