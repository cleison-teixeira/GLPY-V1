...
export default function HomePremiumV2({ onNavigate }: { onNavigate?: (screen: string) => void } = {}) {
  ...
  const PROTOCOL_ROUTE_MAP: Record<string, string> = {
    ...
    'Controle de Efeitos Colaterais': '/preview/protocolo2',
    'Efeitos Colaterais': '/preview/protocolo2',
    efeitosColaterais: '/preview/protocolo2',
    'Anti-Queda de Cabelo': '/preview/protocolo3',
    ...
    'Transição — Parar a Caneta': '/preview/protocolo10',
  ...
  const PROTOCOL_SCREEN_MAP: Record<string, string> = {
    ...
    'Transição — Parar a Caneta':     'transicaoParar',
