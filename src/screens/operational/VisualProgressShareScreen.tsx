...
//
// Esta tela é um mockup visual premium para evolução antes/depois.
// No MVP, fotos, dados e compartilhamento são mockados.
// Firestore, Storage, html2canvas e compartilhamento real serão implementados futuramente.
// O GLPY deve incentivar progresso sem pressionar exposição pública.
// Compartilhar deve ser opcional e emocionalmente seguro.
...
const S_STRIP_BG   = '#1a2e44';   // gap color (separator)
const S_STRIP_CELL = '#0d1f35';   // cell bg
...
// lucide-react não tem ícones de marca; usando ícones funcionais + labels claros
const SHARE_OPTIONS = [
...
export default function VisualProgressShareScreen({ onBack }: VisualProgressShareScreenProps) {
  ...
  function handleSaveImage() {
    // Futuramente: html2canvas gerará imagem real para story/status/feed.
  ...
  // photos grid — align-items: end faz Depois crescer para cima
  ...
  const arrowCircleStyle: React.CSSProperties = {
    ...
    alignItems:     'center',
    justifyContent: 'center',
    // ring que combina com o fundo escuro do story card
    boxShadow:      `0 0 0 5px ${S_BG}`,
  };

  // stats strip — gap 1px com background visível como separador
          ...
          <div style={storyWrap}>
            ...
            <div style={scTopStyle}>
              ...
              <div style={protoWrapStyle}>
                ...
                <span style={protoGreenStyle}>Anti-Rebote</span>
              </div>
            </div>
            ...
            <div style={photosGridStyle}>
              ...
              <div style={photoBeforeStyle}>
                ...
                <div style={photoLabelRowStyle}>
                  ...
                  <span style={photoDateStyle}>Mar 2025</span>
                </div>
              </div>
              ...
              <div style={photoAfterStyle}>
                ...
                <div style={photoLabelRowStyle}>
                  ...
                  <span style={photoDateStyle}>Mai 2025</span>
                </div>
              </div>
            ...
            <div style={statsStripStyle}>
              <div style={statCellStyle}>
                <div style={{ ...statValBaseStyle, color: S_GREEN }}>−15,8 kg</div>
        ...
        <GLPYCard variant="light">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <div style={resumoRowStyle}>
              ...
              <span style={resumoValGreenStyle}>−15,8 kg</span>
            </div>
            ...
            <div style={resumoRowStyle}>
              ...
              <span style={resumoValGreenStyle}>−16 cm</span>
            </div>
            <div style={resumoDividerStyle} />
            <div style={resumoRowStyle}>
              <span style={resumoKeyStyle}>
              ...
              <span style={resumoValStyle}>63 dias</span>
            </div>
            <div style={resumoDividerStyle} />
            <div style={resumoRowStyle}>
              <span style={resumoKeyStyle}>
              ...
              <span style={resumoValStyle}>Anti-Rebote · Sem. 3</span>
            </div>
          </div>
        </GLPYCard>
